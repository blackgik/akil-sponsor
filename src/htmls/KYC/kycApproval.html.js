export const kycapprovalHTML = `<!DOCTYPE HTML
                                                                ...
                                                                <span
                                                                    style="font-size: 24px; line-height: 36px;"><span
                                                                        style="color:#002366; line-height: 21px;"><strong><span
                                                                            ...
                                                                            <strong>{{member_name}}</strong></span>,</span>
                                                    ...
                                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 35px 0px;font-family:arial,helvetica,sans-serif;"
                                                        ...
                                                        <div class="v-line-height"
                                                            ...
                                                            <p> Congratulations! We are pleased to inform you that
                                                                your KYC
                                                                verification has been successfully approved by {{org_name}}</p>
                                                        ...
                                                        <div class="v-line-height"
                                                            ...
                                                            <p
                                                                ...
                                                                following link <a
                                                                    ...
                                                                    href="{{member_portal}}">https://member.akilaah.com</a>
                                                            </p>
                                                        </div>
                                                        ...
                                                        style="font-size: 18px; line-height: 150%; text-align: left; word-wrap: break-word;color:#002366;">
                                                         ...
                                                         <br />
                                                        <div class="v-line-height"
                                                            style="font-size: 11px; line-height: 150%; text-align: left; word-wrap: break-word;color:#002366;">
                                                            <p
                                                                style="font-size: 11px; line-height: 150%; text-align: justify;">
                                                            </p>
                                                        </div>
                                                        <div class="v-line-height"
                                                            style="font-size: 11px; line-height: 150%; text-align: left; word-wrap: break-word;color:#002366;">
                                                            <p
                                                                style="font-size: 11px; line-height: 150%; text-align: justify;">
                                                                Please make sure to keep your login credentials
                                                                secure and do not share them with anyone. For any
                                                                assistance feel free to reach us at <a
                                                                    style="color: blue; text-decoration: underline;"
                                                                    href="mailto: {{org_email}}">{{org_email}}</a>
                                                            </p>
                                                        </div>
...
export const kycDeclinedHTML = `<!DOCTYPE HTML
PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml"
xmlns:o="urn:schemas-microsoft-com:office:office">
                                                ...
                                                <tr>
                                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 35px 0px;font-family:arial,helvetica,sans-serif;"
                                                        ...
                                                        <div class="v-line-height"
                                                            ...
                                                            <p> We appreciate your interest in joining our platform
                                                                as an organisation. However, after a thorough review
                                                                of the submitted documents for the Know Your
                                                                Customer (KYC) process, we regret to inform you that
                                                                your application has been rejected by our
                                                        ...
                                                        <div class="v-line-height"
                                                            ...
                                                            <p
                                                                style="font-size: 18px; line-height: 150%; text-align: justify;">
                                                                Kindly, log into your account and provide clearer
                                                                and correct information for your KYC verification
                                                        ...
                                                        <div class="v-line-height"
                                                            ...
                                                            <p
                                                                style="font-size: 18px; line-height: 150%; text-align: justify;">
                                                                If you believe there has been an error or if you
                                                                have further documentation to support your
                                                                application, please feel free to contact our support
                                                                team at <a
                                                                    style="color: blue; text-decoration: underline;"
                                                                    href="mailto: {{org_email}}">{{org_email}}</a>
