export const trialplanHtml = `<!DOCTYPE HTML
                                                ...
                                                <tr>
                                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 35px 0px;font-family:arial,helvetica,sans-serif;"
                                                        ...
                                                        <div class="v-line-height"
                                                            ...
                                                            <p> We wanted to remind you that your trial plan with
                                                                Akilaah is expiring soon. You have a few days left
                                                            ...
                                                            <p
                                                                ...
                                                                <span>
                                                                    <ul
                                                                        ...
                                                                        <li>Current Plan: Trial
                                                                        </li>
                                                                        <li>Expiry Date: {{expDate}}
                                                                        </li>
                                                                    </ul>
                                                                </span>
                                                            </p>
                                                    ...
                                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 35px 0px;font-family:arial,helvetica,sans-serif;"
                                                        ...
                                                        <div class="v-line-height"
                                                            ...
                                                            <p style="font-size: 18px; line-height: 150%;">
                                                                To continue enjoying the full benefits of our
                                                                premium features, we encourage you to upgrade to our
                                                                live plan <a
                                                                style="color: blue; text-decoration: underline;"
                                                                href="https://organization.akilaah.com/login">https://organization.akilaah.com</a>.
                                                            </p>
                                                            <p style="font-size: 18px; line-height: 150%;">
                                                                Upgrade today and unlock the full potential of our
                                                                platform!
                                                            </p>
                                                            <p style="font-size: 18px; line-height: 150%;">
