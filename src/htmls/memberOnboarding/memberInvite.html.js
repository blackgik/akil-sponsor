                                                                          ...
                                                                          style="font-size: 24px; line-height: 36px;"><span
                                                                              style="color:#002366; line-height: 21px;"><strong><span
                                                                                  ...
                                                                                  style="line-height: 21px;"><span
                                                                                      style="color: #CB6015; line-height: 21px;">{{member_name}}</span></span></strong></span>
                                                      ...
                                                      <tr>
                                                          <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 25px 15px;font-family:arial,helvetica,sans-serif;"
                                                              ...
                                                              <div class="v-line-height"
                                                                  ...
                                                                  Congratulations! Your Your sponsor
                                                                  <strong>{{name_of_cooperation}}</strong>
                                                                  has onboarded you as an user, and we are
                                                                  thrilled to welcome you to our community. You are now
                                                                  part of us
                                                                  </p>
                                                                  ...
                                                                  <p style="font-size: 14px; text-align: justify;">
                                                                      <span>
                                                                          <ul
                                                                              ...
                                                                              <li>Organisation Unique ID: {{company_code}} (This is your secret pass
                                                                                  into the organisation; please ensure its
                                                                                  confidentiality as it is required for
                                                                                  every login)</li>
                                                                              <li>User Login URL: <a
                                                                                      style="color: blue; text-decoration: underline;"
                                                                                      href="{{member_url}}">https://sponsor.akilaah.com</a>
                                                                              </li>
                                                                          </ul>
                                                                          <br>
                                                                      </span>
                                                          ...
                                                          <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 25px 0px;font-family:arial,helvetica,sans-serif;"
                                                              ...
                                                              <div class="v-line-height"
                                                                  ...
                                                                  <p style="font-size: 18px; line-height: 150%;">
                                                                      ...
                                                                      need assistance, do not hesitate to reach out to
                                                                      <strong>{{name_of_cooperation}}</strong>
                                                                  </p>
