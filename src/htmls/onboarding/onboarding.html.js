export const onboardingHtml = `<!DOCTYPE HTML
                                ...
                                <div style="height: 100%;width: 100% !important;">
                                    ...
                                    <div
                                                                ...
                                                                <span
                                                                    style="font-size: 24px; line-height: 36px;"><span
                                                                        style="color:#002366; line-height: 21px;"><strong><span
                                                                                style="line-height: 21px;">Welcome to AKILAAH!
                                                                            </strong></span>

                                                            </p>
                                                            <p style="font-size: 18px; color:#002366;line-height: 150%; font-size: 18px;">
                                                            Dear <span
                                                            style="color: #CB6015; line-height: 21px; font-size: 18px;"> <strong> {{name_of_cooperation}}</strong></span>, <br>
                                                            </p>
                                                        </div>
                                        ...
                                        <table style="font-family:arial,helvetica,sans-serif;" role="presentation"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 40px 0px;font-family:arial,helvetica,sans-serif;"
                                                        align="left">

                                                        <div class="v-line-height"
                                                            style="font-size: 18px; line-height: 150%; text-align: left; word-wrap: break-word;color:#002366;">
                                                            
                                                            <p> We are thrilled to welcome you to our
                                                                community.</p>
                                                            ...
                                                            <p
                                                                ...
                                                                <span>
                                                                    <ul
                                                                        ...
                                                                        <li>Name of Organisation: {{name_of_cooperation}}</li>
                                                                        <li>Email: {{email}}</li>
                                                                        <li>Password: {{password}}</li>
                                                                        <li>Organisation Unique Code: {{company_code}} (This is your secret pass into your
                                                    ...
                                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 40px 0px;font-family:arial,helvetica,sans-serif;"
                                                        ...
                                                        <div class="v-line-height"
                                                            ...
                                                            <p style="font-size: 18px; line-height: 150%;">
                                                                Be informed your account is on 14 days trial, to
                                                                successfully complete the onboarding process, ensure
                                                                to perform your KYC verification and make payment.
                                                            </p>
                                                            <p style="font-size: 18px; line-height: 150%;">
                                                            ...
                                                            <p>Once again, welcome to AKILAAH! We look forward to
